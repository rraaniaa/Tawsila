...
class ClientAdapter(private val clientList: List<UserDTO>) : RecyclerView.Adapter<ClientAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Ajoutez ici d'autres données du client si nécessaire
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        // Ajoutez ici d'autres vues pour les données supplémentaires du client si nécessaire
    }
}
